...
public class ConnectionSetup {
     ...
     * with {@link com.example.essentialstracker.exceptions.BleGattException} if the device is not in range.
     */
    ...
    public static class Builder {
         ...
         *                    with {@link com.example.essentialstracker.exceptions.BleGattException} if the device is not in range after a
         *                    30 seconds timeout.
