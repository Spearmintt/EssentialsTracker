package com.example.essentialstracker.scan;

import android.bluetooth.le.BluetoothLeScanner;
import android.os.Parcel;
import android.os.Parcelable;
import androidx.annotation.IntDef;
import com.example.essentialstracker.internal.scan.ExternalScanSettingsExtension;
...
public class ScanSettings implements Parcelable, ExternalScanSettingsExtension<ScanSettings> {
    ...
    public static final class Builder implements ExternalScanSettingsExtension.Builder {
        ...
        /**
         * {@inheritDoc}
         * If set to true and Location Services are off a {@link com.example.essentialstracker.exceptions.BleScanException} will be emitted.
         * <p>Default: true.</p>
         */
        @Override
