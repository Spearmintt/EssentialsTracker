...
public interface BackgroundScanner {
     ...
     * @throws com.example.essentialstracker.exceptions.BleScanException thrown if not possible to start the scan
     */
    @RequiresApi(26 /* Build.VERSION_CODES.O */)
     ...
     * @throws com.example.essentialstracker.exceptions.BleScanException scan failure
     */
