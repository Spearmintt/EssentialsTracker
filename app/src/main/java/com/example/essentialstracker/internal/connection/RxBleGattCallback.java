...
import com.example.essentialstracker.HiddenBluetoothGattCallback;
import com.example.essentialstracker.RxBleConnection.RxBleConnectionState;
import com.example.essentialstracker.RxBleDeviceServices;
import com.example.essentialstracker.exceptions.BleDisconnectedException;
import com.example.essentialstracker.exceptions.BleGattCharacteristicException;
import com.example.essentialstracker.exceptions.BleGattDescriptorException;
...
public class RxBleGattCallback {
     ...
     * It's intended to be used only with a {@link com.example.essentialstracker.RxBleCustomOperation} in a performance
