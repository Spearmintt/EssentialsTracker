 ...
 * {@link com.example.essentialstracker.RxBleConnection#readCharacteristic(UUID)} or
 * {@link com.example.essentialstracker.RxBleConnection#setupIndication(UUID)}. If the data in emitted byte arrays is stored using
