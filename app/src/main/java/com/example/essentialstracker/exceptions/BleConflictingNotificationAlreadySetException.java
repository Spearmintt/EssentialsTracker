...
/**
 * An exception being emitted from {@link com.example.essentialstracker.RxBleConnection#setupNotification(UUID)}/
 * {@link com.example.essentialstracker.RxBleConnection#setupIndication(UUID)} or overloads in case when an opposite
