...
public class BleCannotSetCharacteristicNotificationException extends BleException {
     ...
     * {@link com.example.essentialstracker.RxBleConnection#setupNotification(BluetoothGattCharacteristic, NotificationSetupMode)} or
     * {@link com.example.essentialstracker.RxBleConnection#setupIndication(UUID, NotificationSetupMode)} can be used with
