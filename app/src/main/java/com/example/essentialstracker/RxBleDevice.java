...
public interface RxBleDevice {
     ...
     *
     * @return observable that will emit {@link com.example.essentialstracker.RxBleConnection.RxBleConnectionState} changes
     */
     ...
     *                    If false, the connection will fail with {@link com.example.essentialstracker.exceptions.BleGattException} if
